                  ...
                  <li class="nav-item dropdown">
                     ...
                     <div class="dropdown-menu dropdown-menu-right scale-up">
                        <ul class="dropdown-user">
                           ...
                           <li role="separator" class="divider"></li>
                           <li><a href="#" onclick="event.preventDefault();document.getElementById('logout_form').submit();"><i class="fa fa-power-off"></i> Logout</a></li>
                           <form id="logout_form" action="{{ route('admin.logout') }}" method="post" class="d-none">@csrf</form>
                        </ul>
                     </div>
                  </li>
               </ul>
